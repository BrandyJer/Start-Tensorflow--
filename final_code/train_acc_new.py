...
#            train_queue = ["train_data2.tfrecords"]
            train_queue = ["train_new0.tfrecords", "train_new1.tfrecords", "train_new2.tfrecords", "train_new3.tfrecords", "train_new4.tfrecords", "train_lj.tfrecords"]
...
#            opt.minimize(total_loss, global_step=global_step)
            ...
            train_writer = tf.summary.FileWriter('/root/linjian/darknet_0/models/try-linjian/all_data/0_wd4e5-0.15', sess.graph)
            sess.run(init)
...
#                saver.restore(sess, model_file)
                model_file=tf.train.get_checkpoint_state('./models/try-linjian/all_data/0_wd4e5-0.15')
...
#                    checkpoint_path = os.path.join('/root/classify/model', 'dp15_model.ckpt')
                    checkpoint_path = os.path.join('/root/linjian/darknet_0/models/try-linjian/all_data/0_wd4e5-0.15', 'model.ckpt')#save model path
